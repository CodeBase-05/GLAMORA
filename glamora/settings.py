"""
Django settings for glamora project.
"""
...
# Always use MySQL - no SQLite
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': config('DB_NAME', default='glamora_db'),
...
# Custom authentication - using Customer model instead of Django User
# No Django auth URLs needed

# Use signed cookies for sessions so we don't need django_session table
SESSION_ENGINE = 'django.contrib.sessions.backends.signed_cookies'
SESSION_COOKIE_NAME = 'glamora_session'
